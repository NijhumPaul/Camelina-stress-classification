...
if __name__ == '__main__':
    ...
    pre_in_model = tf.keras.applications.xception.preprocess_input
    ...
    outputs=tf.keras.applications.Xception(include_top=True,weights=None,classes=class_num)(inputs)
    ...
    #model_name = xception_model.name 
